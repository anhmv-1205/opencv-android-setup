 [Origin](https://github.com/VlSomers/native-opencv-android-template)
...
4. Install *OpenCV Android release* :
    * Download [OpenCV Android release](https://sourceforge.net/projects/opencvlibrary/files/4.5.3/opencv-4.5.3-android-sdk.zip/download) or download latest available Android release on [OpenCV website](https://opencv.org/releases/).
...
5. Link your *Android Studio* project to the *OpenCV Android SDK* you just downloaded :
    * [MacOS|Ubuntu] Open [gradle.properties](gradle.properties) file and edit following line with your own *OpenCV Android SDK* directory path :
    * [MacOS|Ubuntu]
